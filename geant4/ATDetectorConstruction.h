#ifndef ATDETECTORCONSTRUCTION_HH
#define ATDETECTORCONSTRUCTION_HH
...
class ATDetectorConstruction : public G4VUserDetectorConstruction
{
    public:
        ATDetectorConstruction();
        virtual ~ATDetectorConstruction() { ; }
